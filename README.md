...
<h3 align="center">
    🔹
    <a href="https://github.com/Whisperpiano/whisper_portfolio/issues">Report Bug</a> &nbsp; &nbsp;
    🔹
    <a href="https://github.com/Whisperpiano/whisper_portfolio/issues">Request Feature</a>
</h3>
...
Clone the repo:
   ```sh
   git clone https://github.com/Whisperpiano/whisper_portfolio.git
   ```
### Open the project

Navigate to the project directory:
   ```sh
   cd whisper_portfolio
   ```
